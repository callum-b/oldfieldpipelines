...
module load bioinfo/MACS/3.0.0
...
snakemake --slurm --rerun-incomplete --keep-going --jobs 15 call_all_peaks_autodetect  --default-resources slurm_account=YOUR_ACCOUNT_NAME slurm_partition=workq ## run up to 15 jobs in parallel for rule call_all_peaks_autodetect
